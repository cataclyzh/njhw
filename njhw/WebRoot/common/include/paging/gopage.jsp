			...
			<td nowrap style="font-size: 12px;border:0;">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr align="right">
						...
						共
							<font color="#CB5C0B">${page.totalCount}</font>条&nbsp;&nbsp;
							第
							<font color="#CB5C0B">${page.pageNo}</font>页/共
							<font color="#CB5C0B">${page.totalPages}</font>页&nbsp;&nbsp;
							...
							<c:if test='${page.pageNo < page.totalPages}'>
								<a href='javascript:behindPage()'>下一页</a>&nbsp;&nbsp;
		 						<a href='javascript:lastPage()'>最末页</a>&nbsp;&nbsp;
		 					</c:if>


							第&nbsp;
							<input type='text' name='gopageNo' id="gopageNo"
...
<td style="font-size: 12px;border:0;">
							<img src="<%=path%>/common/include/paging/go.jpg"
								onclick="GOPage('up');" style="cursor: hand;"
