	 ...
	 <table align="center" id="hide_table"  border="0" width="100%" class="form_table">
		  <tr>
			...
			<tr>
				...
				<td width="30%">
					<span class="form_label">
					  	   <s:select name="questStatus"  id="questStatus"  headerValue="已回复" cssClass="input180box" 
						      list="#{'2':'已回复'}" 
						      value="#{'2':'已回复'}"/>
					</span>
				</td>
...
//查看明细操作
function detail(id){
	var url = "${ctx}/common/answeredQuestion/detail.act?questId="+id;
