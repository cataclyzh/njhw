...
function toTesco(){
	...
	f.action="${ctx}/common/answerQuestion/toTescoDeal.act?TescoAPRoleId="+TescoAPRoleId;
	f.submit();
}
...
//回复操作
function formSubmit() {
	var url="${ctx}/common/answerQuestion/answer.act";
...
function init(){
  ...
  if(flag){
	  easyAlert('提示信息','转发乐购操作成功！','info',function(){closeEasyWin('answer_question_detail');});
  }
}
