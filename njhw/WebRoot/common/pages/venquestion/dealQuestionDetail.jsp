...
<h:page id="receive_panel" width="100%" title="问题贴信息">
	<table align="center" border="0" width="100%" class="form_table">
		...
		<tr class="form_bottom">
			<td colspan="9">
				<c:if test="${orgType !='1'}">
					<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-ok" onclick="javascript:toTesco();" >转乐购</a>&nbsp;&nbsp;
				</c:if>
...
<h:page id="send_panel" width="100%" title="问题贴追加">
	<form id="message_form" action="dealAnswer.act" method="post"  autocomplete="off" > 
		<input type="hidden" name="TescoAPRoleId" id="TescoAPRoleId" value="${TescoAPRoleId}"/>
		...
		<table align="center" border="0" width="100%" class="form_table">
			...
			<tr>
				...
				<td><s:textarea name="ansContent" theme="simple" cssStyle="width:500px;height:120px;"  cssClass="textarea"/></td>
			</tr>
			<tr>
...
//转乐购处理
function toTesco(){
	var TescoAPRoleId=document.getElementById("TescoAPRoleId").value;		
	var f=document.getElementById("message_form");
	f.action="${ctx}/common/dealQuestion/dealtoTescoDeal.act?TescoAPRoleId="+TescoAPRoleId;
	f.submit();
}

//关闭
function closeWin(){
	closeEasyWin('deal_question_detail');
}

//回复操作
function formSubmit() {
	var url="${ctx}/common/dealQuestion/dealAnswer.act";
