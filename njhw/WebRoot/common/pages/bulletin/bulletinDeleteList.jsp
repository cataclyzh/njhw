...
<form id="queryForm" name="queryForm" action="msgBoardAction_save.act" method="post" autocomplete="off">
	...
	<page:pager id="list_panel" width="100%" buttons="${buttons}" title="物业通知">
		<d:table id="row" name="page.result" export="false" class="table" requestURI="msgBoardAction_queryAndDelete.act">
			<d:col  style="width:45" class="display_centeralign"  title="<input type=\"checkbox\" style=\"border-right-style:noneborder-top-style:none;border-bottom-style:none;border-left-style:none;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;border-left-width:0px;\" id=\"checkAll\"/>" >
				<input type="checkbox" name="_chk" id="_chk" style="border-right-style:noneborder-top-style:none;border-bottom-style:none;border-left-style:none;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;border-left-width:0px;" class="checkItem" value="${row.MSGID}" onclick="selectCheckbox(this)" />
			</d:col>
			...
			<d:col class="display_centeralign" media="html" title="操作">
			    <a  style="cursor:pointer" onclick="modifyData('${row.MSGID}')" onmousemove="this.style.color='#ffae00'" onmouseout="this.style.color='#8090b4'">[修改]</a>&nbsp;
