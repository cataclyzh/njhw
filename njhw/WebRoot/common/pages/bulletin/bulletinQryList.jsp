...
<body style="margin:0;padding:0;">
	...
	<jsp:include page="/app/integrateservice/header.jsp">
		...
		<div class="main_fax_left">
			<iframe src="${ctx}/common/pages/bulletin/left.jsp" width="100%" scrolling="yes" style="height: 300px;"
				name="main_frame_left" id="main_frame_left" frameborder="0"></iframe>
		</div>

		<div class="main_fax_right">

			<iframe src="${ctx}/common/bulletinMessage/msgBoardAction_save.act" width="100%" name="main_frame_right" height="630"
				id="main_frame_right" scrolling="auto" frameborder="0"></iframe>
		</div>
		<div class="clear"></div>
		<div>
			<iframe src="${ctx}/common/pages/bulletin/footer.jsp" width="100%" height="103" scrolling="no"
