...
- Description: 功能菜单管理框架页面
--%>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>功能菜单管理框架</title>
...
<body style="height:100%;width:100%;"  class="easyui-layout">
	<div region="west" split="true" title="功能菜单树" style="width:150px;height:auto;background:#fafafa;padding:0px;overflow:hidden;">
		<iframe scrolling="auto" frameborder="0" name="ifrmMenuTree" id="ifrmMenuTree"
		 src="${ctx}/common/menuMgr/menuTree.act?orgid=${orgid}"
		border="0" marginheight="0" marginwidth="0" frameborder="0" 
		style="width:100%;height:100%;padding:0px;"></iframe>		
	</div>
	<div region="center" title="功能菜单列表" style="padding:0px;background:#fafafa;overflow:hidden;">
		<iframe scrolling="auto" frameborder="0" name="ifrmMenuSubList" id="ifrmMenuSubList" 
