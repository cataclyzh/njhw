...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/common/userMgr/orgTreeData.act?type=open");
	tree.loadXML("${ctx}/common/userMgr/orgTreeData.act?type=init&id=<c:out value='${_orgid}'/>");
