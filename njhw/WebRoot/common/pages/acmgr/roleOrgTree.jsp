...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/common/roleMgr/orgTreeData.act?nodeId=");
	tree.loadXML("${ctx}/common/roleMgr/orgTreeData.act?nodeId=<c:out value='${_orgRoot}'/>");
