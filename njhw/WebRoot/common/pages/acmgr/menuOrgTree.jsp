...
- Description:功能菜单信息管理机构树页面
--%>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>功能菜单信息管理机构树</title>	
...
<script type="text/javascript">
	...
	tree.setXMLAutoLoading("${ctx}/common/menuMgr/orgTreeData.act?nodeId=");
	tree.loadXML("${ctx}/common/menuMgr/orgTreeData.act?nodeId=<c:out value='${_orgRoot}'/>");
	...
	function openPath(itemId){		
		...
		if(url!=null&&url!=""){
			parent.frames.ifrmMenuList.location.href = url;
		}
