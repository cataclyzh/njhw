...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="10%">发件人：</td>
    <td width="40%"><input name="" readonly="readonly" type="text" class="show_inupt" value="${receiver }" /></td>
    <td width="10%">发送时间：</td>
    <td width="40%"><input name="" readonly="readonly" type="text" class="show_inupt" value="${msgtime }" /></td>
  </tr>
  <tr>
    <td>主题：</td>
  ...
  <tr>
    ...
    <td colspan="3"><textarea name="" readonly="readonly" class="show_textarea" >${content }</textarea></td>
  </tr>
</table>
</div>
<div class="show_pop_bottom"><a style="cursor: pointer;" onclick="parent.closeIframe()">关闭窗口</a></div>
</form>
   </div>
   <div class="clear"></div>
  </div>
