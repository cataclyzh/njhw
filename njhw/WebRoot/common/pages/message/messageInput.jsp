...
<body topmargin="0" leftmargin="0" rightmargin="0"
	...
	<div class="main_conter">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td style="padding-right: 50px;"><s:textfield name="receiver"
								...
								cssClass="main_input" size="70" readonly="true" onfocus="this.blur()"
					...
					<tr>
						...
						<input name="send" id="send"
							 type="button" id="submitbutton" value="发送" style="width: 120px;font-size: medium;"
							onclick="javascript: formSubmit();" />
							
						<input name="reset" id="reset"
							 type="button" value="重置" style="width: 120px;font-size: medium;"
		...
		<div style="width: 28%;float: left;margin-right: 10px;">
			...
			<iframe id='iframe-contact' name='iframe-contact' width="100%"
				 height="440px" scrolling="auto" frameborder="0"></iframe>
	...
	<script type="text/javascript" src="${ctx}/common/pages/message/js/messageInput.js"></script>
	<script type="text/javascript">
		...
		window.parent.frames["main_frame_right"].location.replace("msgBoxAction_querySenderbox.act");
