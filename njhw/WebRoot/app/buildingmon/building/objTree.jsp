...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/app/buildingmon/objTreeData.act?type=open");
	tree.loadXML("${ctx}/app/buildingmon/objTreeData.act?type=init&id=6");//
	...
	//	alert("树节点ID:"+tree.contextID+",菜单ID:"+menuid);
		if(menuid=="muItem_DELETE"){
			...
			tree.smartRefreshBranch(tree.contextID,"${ctx}/app/buildingmon/objTreeData.act?nodeId="+tree.contextID);
		}
	}
	//树链接处理函数------------------------------------------------------////
