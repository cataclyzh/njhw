...
function easyAlert(d, c, b, a) {
	top.easyAlertTop(d, c, b, a);
}
function easyConfirm(c, b, a) {
	top.easyConfirmTop(c, b, a)
}
function ggyy() {
	var code = [ "<html>" ];
	code.push("<body style='background-color:#DFE7FE;'>");
	code.push("</body>");
	code.push("</html>");
	return code.join("");
}
//f代表div的ID,I代表div的name,a代表URL,d代表width,k代表height
function openEasyWin(f, i, a, d, k, c, j, n) {
...
function openEasyWinNotResizable(f, i, a, d, k, c, j) {
	var e = (screen.availWidth - d) / 2;
	var g = (screen.availHeight - k) / 2;
	var b = '<div id="'
			+ f
			+ '" class="easyui-window" modal="true" draggable="true" resizable="false" collapsible="false" minimizable="false" maximizable="false" style="top:100px;300px;width:400px;height:300px;padding:0px;background:#fafafa;overflow:visible;" closed="true" ><Iframe id="ifrmComWin" name="ifrmComWin" style="width:100%;height:100%;" src="'
			+ a
			+ '"  frameborder="0"></iframe><iframe id="ifrmComWin_iframe"  style="overflow:auto;width:110%;height:110%;position:absolute;z-index:-1;left:0;top:-20px;" src="javascript:parent.ggyy()"  frameborder="0"></iframe></div>';
	var h = window.top.$(b).appendTo(window.top.document.body);
	h.window( {
		title : i,
		showType : "slide",
...
function openAdminConfirmWin(fn, params) {
	var b = '<div id="adminConfirm" class="easyui-window" modal="true" draggable="false" resizable="false" collapsible="false" minimizable="false" maximizable="false" style="top:100px;300px;width:400px;height:300px;padding:0px;background:#fafafa;overflow:visible;" closed="true" ><Iframe id="ifrmAdminConWin" name="ifrmAdminConWin" style="width:100%;height:430px;" src="'
			+ _ctx + '/common/userOrgMgr/adminConfirm.act'
			+ '"  frameborder="0"></iframe></div>';
	var h = window.top.$(b).appendTo(window.top.document.body);
	h.window( {
		title : "管理员刷卡确认",
		...
		onBeforeClose: function() {
			if (top.ifrmAdminConWin.window.isSuccess) {
				fn(params);
			} else {
			}
		},
