...
Qmap.Map3d = Qmap.Class({
    ...
    */
            ...
            addLoadEvent(function() {//在window.onload加载完后执行下面的事件
                ...
                */
                ...
                try {
                    ...
                    //结束初始化设置 初始化前可调用
                     if (obj.options.licensesvr != null && obj.options.licensesvr != "") {
                        obj.SetLicenseSvr(obj.options.licensesvr);
                     }
    ...
    SetLicenseSvr: function(svrUrl) {
        this.handle.QM_SetLicenseSvr(svrUrl);
    },
    /*----------------------------------------------=====END=====--------------------------------------------------*/
