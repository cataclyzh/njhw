...
<head>
    ...
    function SetVideoEffect()
    {
		...
		<input type="hidden" name="checkit" value = "10.250.247.170"  id="TextIP0" checked >
		<input type="hidden" name="checkit"  value = "10.250.247.171"  id="TextIP1"  checked>
		<input type="hidden" name="checkit" value = "10.250.247.172"  id="TextIP2" checked>
		<input type="hidden" name="checkit"  value = "10.250.247.173"  id="TextIP3" checked>
		<input type="hidden" name="checkit" id="TextIP" onClick="StartPlayView_Free()" checked>
         <!--  port:&nbsp;-->
       ...
       <!-- rtsp端口:&nbsp;-->
        ...
        <div style="width:432px ;margin-top:-20px">
        <input id="Hidden1" type="hidden" />   
        <div style="width:432px;float:left;overflow:hidden; z-index: 510;">
            &nbsp;&nbsp;&nbsp;<br />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <!-- 添加预览控件（需要先在windows下注册） -->
            <object classid="clsid:D5E14042-7BF6-4E24-8B01-2F453E8154D7"   style = "margin-top: -30px"id="PlayViewOCX"  width="432" height="242" name="ocx"  >
            </object>
        </div>
    </div>
</body>
