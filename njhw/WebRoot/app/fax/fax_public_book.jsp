...
<link href="css/newtree.css" rel="stylesheet" type="text/css" />
...
<div class="main_right3">
	...
	<div class="main_right3_more">
		...
		<div class="main_right3_more_fd" id="amplifyA"
			style="display: none;;float:left" onclick="amplify();" title="放大"></div>
		<div class="refresh_main_right3_more" id="refresh_List"
			style="float:left;display: none;" onclick="refreshAddList();"
			title="刷新"></div>
	</div>
	<div class="search-input">
		<input type="text" id="searchTJ" onfocus="inputFun(this, 0)"
			onblur="inputFun(this, 1)" value="请输入姓名或电话"
			style="width: 160px; color: gray;height: 20px;" />
	</div>
	<div class="close_search" id="close_search" title="清除"
		onclick="clear_search(this)" style="display: none;"></div>
	<div class="search_span">
		<button type="button" class="search-btn" onclick="searchInfo()"
...
$("#searchBtn").button();
    ...
    function dialing(called, pname) {
    	...
    	document.getElementById("fo_to").value = called;
    	
    	
  		<%-- var url = "${ctx}/app/integrateservice/inputCallPhone.act?selfMac="+'<%=selfMac%>'+"&selfTel="+'<%=selfTel%>'+"&called="+called+"&pname="+pname;
