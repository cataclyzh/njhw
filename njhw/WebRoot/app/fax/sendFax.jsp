...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>已发传真页面</title>
		<link type="text/css" rel="stylesheet" href="css/sendFax.css" />
    	...
    	*/
		function showResponse(responseText,statusText) {
		   if(statusText=="success"){
			 	$("#send_fax_list_page").replaceWith(responseText);
		   } else {
				alert("查询失败!");
		   }
	    }
	    ...
	    function delRecord(){
			...
			$.ajax({
				type: "POST",
				url: "${ctx}/app/fax/deleteSendFax.act",
				data: {"ids": ids},
				dataType: 'text',
				async : false,
	    ...
	    */
	    function synSendFax(){
			...
			var url = "${ctx}/app/fax/synSendFax.act";
	...
	<body>
		<div class="main">
			...
			<div class="main_top">
				...
				<input type="button" value="同步" class="main_top_btn3" onclick = "javascript:synSendFax();"/>
				<form action="sendFaxList.act" id="saveForm">
						...
						<tr>
							...
							<td>
								<input type="text"
									...
									id="sendFaxStartDate" name="sendFaxStartDate" class="table_input" /><span>-</span>
									<input type="text"
									onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss' })"
									id="sendFaxEndtDate" name="sendFaxEndtDate" class="table_input" />
							</td>
							...
							<td>
								<input type="text" name="title" id="title" class="table_input" />
							</td>
							<td style="padding-left: 10px">
								<span>状态</span>
							</td>
