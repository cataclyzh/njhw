...
<head>
<title>My JSP 'fax_inbox_list.jsp' starting page</title>
...
<body style="margin:0;padding:0;overflow-x:hidden">
	<div class="main_left_main1">
		...
		<div class="main_conter">
			<div class="main1_fax_top"	style="margin-top: 5px;width: 97%;text-align: right; position: absolute;">
				...
				<form action="" method="get">
					...
					</select> &nbsp; <input type="text" id="from" onfocus="this.blur()" 
		...
		<script type="text/javascript" src="js/fax_inbox_list.js"></script>
