...
<body style="background:#fff;">
				...
				<div class="bgsgl_conter" style="min-height: 700px;">
					<form id="queryForm" action="initNewTheMenu.act" method="post"  autocomplete="off">
						<table cellpadding=0 cellspacing="0" style="text-align:left; line-height:22px; font-size:14px; color:#333; border-collapse:collapse; border:1px solid #e4e4e4;">
							<thead style="height:50px; background-color:#eeeef0; font-weight: bold;">
								
								  <th style="height:100%; border-style:none;width:6%; " align="right">一周菜单发布&nbsp;</th>
								  <th style="height:100%; border-style:none;width:15%;" align="left"><div class="botton_from a" ><a href="javascript:void(0);"  onclick="javascript:openEasyWin('cdgl','菜单管理','${ctx}/app/din/queryDishes.act', '1150' ,'410');">菜单管理</a> </div></th>
								  <th style="height:100%; border-style:none;width:13%;" align="left"></th>
								  <th style="height:100%; border-style:none;width:13%;" align="left">&nbsp;</th>
								  <th style="height:100%; border-style:none;width:13%;" align="left">&nbsp;</th>
								  <th style="height:100%; border-style:none;width:13%;" align="left">&nbsp;</th>
								  <th style="height:100%; border-style:none;width:13%;" align="left">&nbsp;</th>
								  <th style="height:100%; border-style:none;" align="left">&nbsp;</th>
								  
							</thead>
							<thead style="height:50px; background-color:#eeeef0; font-weight: bold;">
								<th style="height:100%; border-style:none;width:6%;"> </th>
								<th style="height:100%; border-style:none;width:15%;" align="center">星期一</th>
								<th style="height:100%; border-style:none;width:13%;" align="center">星期二</th>
								<th style="height:100%; border-style:none;width:13%;" align="center">星期三</th>
								<th style="height:100%; border-style:none;width:13%;" align="center">星期四</th>
								<th style="height:100%; border-style:none;width:13%;" align="center">星期五</th>
								<th style="height:100%; border-style:none;width:13%; color: green" align="center">星期六</th>
								<th style="height:100%; border-style:none;color: red" align="center">星期日</th>
							</thead>
							<tr valign="top" style="height:10px; border-style:none;">
							  <td style="height:100%; border-style:none;width:6%;"></td>
							  <td style="height:100%; border-style:none;width:15%;"></td>
							  <td style="height:100%; border-style:none;width:13%;"></td>
							   <td style="height:100%; border-style:none;width:13%;"></td>
							    <td style="height:100%; border-style:none;width:13%;"></td>
							     <td style="height:100%; border-style:none;width:13%;"></td>
							      <td style="height:100%; border-style:none;width:13%;"></td>
							...
							<tr valign="top" style="height:150px;" >
								<th align="center" valign="middle" style="width:7%;height:100%;border-style:none;">早餐</th>
								<td style="height:100%; width:13%;border-style:none; align:center">
									<div class="tooltip" editMenu="editMenu1" listMenu="list0" style="height:100%; width:100%;" >
									<div style="height:100px; width:100%;overflow:auto;" id="list0">
								...
								<td style="height:100%; width:13%;border-style:none; align:center" >
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list3" >
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list6">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list9">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list12">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list15">
								...
								<td style="height:100%; width:15%;border-style:none; align:center">
									<div class="tooltip" editMenu="editMenu7" listMenu="list18" style="height:100%; width:100%;">
									<div style="height:100px; width:100%; overflow:auto;" id="list18">
							...
							<tr valign="top" style="height:150px; " class="tooltip" editMenu="editMenu8" listMenu="list1">
								<th align="center" style="width:7%;height:100%;border-style:none;"  valign="middle" >午餐</th>
								<td style="height:100%; width:13%;border-style:none;">
									<div class="tooltip" editMenu="editMenu8" listMenu="list1" style="height:100%; width:100%;">
									<div style="height:100px; width:100%; overflow:auto;" id="list1">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list4">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%;overflow:auto;" id="list7">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list10">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list13">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list16">
								...
								<td style="height:100%;width:15%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list19">
							...
							<tr valign="top" style="height:150px; " class="tooltip" editMenu="editMenu8" listMenu="list1">
								<th align="center" style="width:7%;height:100%;"  valign="middle" >晚餐</th>
								<td style="height:100%; width:13%;border-style:none; align:center">
									<div class="tooltip" editMenu="editMenu15" listMenu="list2" style="height:100%; width:100%;">
									<div style="height:100px; width:100%; overflow:auto;" id="list2">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list5">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list8">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list11">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list14">
								...
								<td style="height:100%; width:13%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list17">
								...
								<td style="height:100%; width:15%;border-style:none; align:center">
									...
									<div style="height:100px; width:100%; overflow:auto;" id="list20">
