...
Date.prototype.StringToDate = function() {
	var DateStr = this;
...
Date.prototype.compare = function(DateStr) {
	var DateOne = this;
	var DateTwo = new Date(DateStr);
	// alert(DateOne.getTime() + DateTwo.getTime());
