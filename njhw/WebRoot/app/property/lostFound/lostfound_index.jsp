...
<body style="margin:0;padding:0;">
	<div class="main_index">
		...
		<div class="main_fax_left">
			<iframe src="${ctx }/app/property/lostFound/lostfound_left.jsp" width="100%" scrolling="no" height="750"
				name="main_frame_left" id="main_frame_left" frameborder="0"></iframe>
		</div>

		<div class="main_fax_right">

			<iframe src="${ctx }/app/pro/showLostFoundsList.act" width="100%" name="main_frame_right" height="750"
				id="main_frame_right" scrolling="auto" frameborder="0"></iframe>
		</div>
		<div class="clear"></div>
		<div>
			<iframe src="${ctx }/app/property/lostFound/lostfound_footer.jsp" width="100%" height="103" scrolling="no"
