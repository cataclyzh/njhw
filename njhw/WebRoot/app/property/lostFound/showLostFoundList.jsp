...
<!--此处写页面的内容 -->
<div class="fkdj_from">
<form id="queryForm" name="queryForm" action="showLostFoundsList.act" method="post">
	...
	<page:pager id="list_panel" width="100%" buttons="${buttons}" title="结果列表">
		<d:table name="page.result" id="row" cellspacing="0" cellpadding="0" class="table">
			<d:col  style="width:45"   class="display_centeralign"  title="<input type=\"checkbox\" class=\"in_sss_left\" id=\"checkAll\"/>" >
				<input type="checkbox" name="_chk" id="_chk" class="checkItem in_sss_left" value="${row.LOST_FOUND_ID}" onclick="selectCheckbox(this)" />
			</d:col>
			...
			<d:col class="display_centeralign" title="操作">
				<c:if test="${row.LOST_FOUND_STATE == 0}">
					<span class="display_centeralign" onclick="javascript:modifyOneLostFoundPrepare('${row.LOST_FOUND_ID}')" onmousemove="this.style.color='#ffae00'" onmouseout="this.style.color='#8090b4'" style="cursor: pointer">&nbsp;[修改]&nbsp;</span>
					<span class="display_centeralign" onclick="javascript:claimOneLostFoundPrepare('${row.LOST_FOUND_ID}')" onmousemove="this.style.color='#ffae00'" onmouseout="this.style.color='#8090b4'" style="cursor: pointer">&nbsp;[认领]&nbsp;</span>
				</c:if>
				<c:if test="${row.LOST_FOUND_STATE == 1}">
					<span class="display_centeralign" onclick="" onmousemove="this.style.color='#8090b4'" onmouseout="this.style.color='#8090b4'" style="cursor: default;">&nbsp;[修改]&nbsp;</span>
					<span class="display_centeralign" onclick="" onmousemove="this.style.color='#8090b4'" onmouseout="this.style.color='#8090b4'" tyle="cursor: default;">&nbsp;[认领]&nbsp;</span>
				</c:if>
			</d:col>
		</d:table>
	</page:pager>
