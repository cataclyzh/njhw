...
<script type="text/javascript">
	function selectRespondents() {
		var url = "${ctx}/app/visitor/frontReg/respondentsTreeSelectForIframe.act?state=notAll";
		var params = "";
		url += params;
...
<body style="margin:0;padding:0;">
	...
	<jsp:include page="/app/integrateservice/header.jsp">
		...
		<div class="main_fax_left">
			<iframe src="${ctx}/app/property/conference/conference_left.jsp" width="100%" scrolling="no"
				name="main_frame_left" id="main_frame_left" frameborder="0" height="750"></iframe>
		</div>

		<div class="main_fax_right">
			<iframe src="${ctx}/app/pro/addOnePrepare.act" width="100%" name="main_frame_right"
				id="main_frame_right" scrolling="auto" frameborder="0" height="750"></iframe>
		</div>
		<div>
			<iframe src="${ctx}/app/property/conference/fax_footer.jsp" width="100%" height="103" scrolling="no"
