		...
		<div class="show_from" style="padding-top:10px;">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="336px"><input class="fkdj_from_input" type="text" style="width:320px" name="outName" id="outName" readonly="readonly" value="${vm.USER_NAME}" />
				...
				<tr>
					<td>申请人单位</td>
					<td width="336px">
                        <input type="text" class="fkdj_from_input" style="width:320px" id="orgName" name="orgName" readonly="readonly" value="${vm.ORG_NAME}" />
                        <input  type="hidden" name="orgId" id="orgId" />
                    </td>
					<td >联系方式</td>
					<td width="336px"><input class="fkdj_from_input" type="text" style="width:320px" name="phonespan" id="phonespan" readonly="readonly" value="${userExp.telNum}"/></td>
				</tr>
				<tr>
		  ...
		  <div class="bgsgl_right_list_left">备注</div>
				...
				<tr>	
				<td><textarea name="add_conferenceDetailService" id="add_conferenceDetailService" style="width:900px;height:200px;"></textarea></td>
				</tr>
