...
$(document).ready(function(){
	...
	function selectRespondents() {
		...
		var url = "${ctx}/app/visitor/frontReg/respondentsTreeSelect.act?state=notAll";
		var params = "";
		url += params;
...
<div class="khfw_wygl" >
	...
	<form id="modifyform" name="modifyform" action="modifyOneConference.act" method="post" target="main_frame_right">
	  ...
	  <tr> 
	    <td><font color="red">*</font>会议名称</td>
   		...
   		<td style="padding-right:10px;"><font color="red">*</font>会议申请人</td>
	    	<td width="336px;"><input name="outName" id="outName"  class="member_form_input" style="width:336px;" type="text" readonly="readonly" value="${view_conference.outName}" /></td>
		<td></td>
	  </tr> 
    <tr>
	    <td>联系方式</td>
