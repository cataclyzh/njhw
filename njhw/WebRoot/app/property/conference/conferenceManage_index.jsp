...
<body style="margin:0;padding:0;">
	<div class="main_index">
		...
		<div class="main_fax_left">
			<iframe src="${ctx}/app/property/conference/conferenceManage_left.jsp" width="100%" scrolling="no"
				name="main_frame_left" id="main_frame_left" frameborder="0" height="800"></iframe>
		</div>

		<div class="main_fax_right">

			<iframe src="${ctx}/app/pro/showConferencesList.act" width="100%" name="main_frame_right"
				id="main_frame_right" scrolling="no" frameborder="0" height="800"></iframe>
		</div>
		<div>
