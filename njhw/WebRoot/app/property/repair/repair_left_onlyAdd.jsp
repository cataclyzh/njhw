...
<body style="margin:0;padding:0;background: white;">
	<div class="main1_main2_left1">
		<ul>
			<li class="main1_addRepair_select"><a id="btn_addRepair" href="javascript:void(0);"></a></li>
			
			<li class="main1_viewRepair"><a id="btn_viewRepair" href="javascript:void(0);"></a></li>
			<!--  
