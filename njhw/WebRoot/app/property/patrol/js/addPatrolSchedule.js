$(document).ready(function() {
	    ...
	    jQuery.validator.methods.checkLine = function(value, element, param) {
			...
			$("#addPatrolScheduleForm").validate({		// 为inputForm注册validate函数
	...
	function showRequest(){
		 return $("#addPatrolScheduleForm").valid();
	}   
	
	function clearInput(){
        document.getElementById("receiver").value="";
        document.getElementById("patrolLineId").value="0";
