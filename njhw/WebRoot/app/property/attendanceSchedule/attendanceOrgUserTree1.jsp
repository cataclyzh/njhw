...
<body STYLE='OVERFLOW:none;background: white; margin: 0;padding: 0;'>
	...
	<script type="text/javascript">
		...
		tree
				.setXMLAutoLoading("${ctx}/app/pro/getAttendanceOrgUserTreeData.act?type=open");
		tree
				.loadXML("${ctx}/app/pro/getAttendanceOrgUserTreeData.act?ids=${ids}&type=init");//
		...
		function saveData() {
			...
			if(treeUId!=null&&treeUId.length>0){
				$.ajax({
				   type: "POST",
				   url: "${ctx}/app/pro/checkStick.act",
