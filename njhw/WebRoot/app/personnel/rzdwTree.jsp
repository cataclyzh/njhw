...
<table width="70%">
	<tr>
		...
		<td align="center">
			<span style="cursor:hand" id="reload" title="刷新" href="javascript:void(0);" onclick="reload();">
				<img src="${ctx}/styles/icons/reload.png"/>
			</span>
		</td>
	</tr>
	<tr></tr>
...
<div id="divTree" style="border:0px;overflow-y:hidden;height:488px;width: 99%"></div>
...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/app/per/rzdwTreeData.act?type=open");
	tree.loadXML("${ctx}/app/per/rzdwTreeData.act?type=init&id=<c:out value='${_orgid}'/>");//
	...
	function HandleMClk(menuid,zoom){
		...
		if(menuid=="muItem_DELETE"){
			...
			tree.smartRefreshBranch(tree.contextID,"${ctx}/app/per/rzdwTreeData.act?orgId="+tree.contextID);
		}
	}
	//树链接处理函数------------------------------------------------------////
