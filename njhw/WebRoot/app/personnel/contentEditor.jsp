...
<body style="background: #FFF;">
	<form id="inputForm" action="${ctx}/app/cms/channelcms/ipHelpSave.act" method="post" autocomplete="off">
		...
		<table align="center" border="0" width="100%" class="form_table">
			<tr>
				...
				<td>
					<input name="title" id="title" size="50" theme="simple"  maxlength="40" value="${article.title}"/>
				</td>
			</tr>
			<tr >
				<td width="10%">
				...
				<td>
					<input name="weight" id="weight" theme="simple" size="18" maxlength="11" value="1">(只能输入数据,列表根据数字大小排序)
				</td>
			</tr>
			<tr id="table_count">
				<td width="10%">
...
/** 在ckeditor.js里删除save关键字
$("class='TB_Button_Image'").click(function(){
});*/
</script>