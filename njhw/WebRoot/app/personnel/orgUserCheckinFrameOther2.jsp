...
<div class="main_index">
	...
	<div split="true" title="人员机构管理" style="width:25%;background:#fafafa;padding:0px;FLOAT:LEFT;height:100%;">
		<iframe scrolling="no" frameborder="0" name="ifrmOrgTree" id="ifrmObjTree" src="${ctx}/app/per/orgTreeUserCheckinOther1.act"
	...
	<div style="width:75%;background:#fafafa;padding:0px;overflow:hidden;FLOAT:LEFT;height:100%;" id = "ifrmObj2">
		<iframe frameborder="0" name="ifrmOrgList" id="ifrmObjList" src="${ctx}/app/personnel/perInfoCheckinOther1.act?opt=init" style="width:100%;height:100%;padding:0px;"></iframe>
	</div>
	</div>
	</div>
	  <div>
