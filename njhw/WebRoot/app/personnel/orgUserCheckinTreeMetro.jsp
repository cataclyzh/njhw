...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/app/per/orgOtherUserCheckinDataMetro.act?type=open");
	tree.loadXML("${ctx}/app/per/orgOtherUserCheckinDataMetro.act?type=init&id=<c:out value='${_orgid}'/>");//
	...
	function reload(){
		...
		if (selectedNode==""){
			 location.reload();
			 parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinMetro.act";
		}else{
			//parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinMetro.act";
			parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinMetro.act?selectedNode=" + selectedNode;
		}
	}
   ...
   var isDra = true;
	...
	function myDragHandler(idFrom,idTo){
	    if(isDra)
	    {
			...
			parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinMetro.act?selectedNode=" + idFrom;
						...
						$.ajax({
						   ...
						   success: function(msg){
							   ...
							   if(msg.message=="0"){
							   		...
							   		parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinMetro.act?selectedNode=" + selectedNodeOld;						
