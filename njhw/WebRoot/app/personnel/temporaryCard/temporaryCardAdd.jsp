...
<head>
  ...
  <body>
    <form  id="inputForm" action="saveTemporaryCard.act"  method="post"  autocomplete="off" >
    <table align="center" border="0" width="100%" class="form_table">
      <tr>
         <td class="form_label"><font style="color:red">*</font>临时卡号：</td>
        <td>
         <s:textfield name="cardId" id="cardId" theme="simple" size="18" maxlength="20"/>
        </td>   
        <td class="form_label"><font style="color:red">*</font>RFID：</td>
        <td>
         <s:textfield name="rfid" id="rfid" theme="simple" size="18" maxlength="20"/>
        </td> 
      </tr> 
	</table>
   <table align="center" border="0" width="100%" class="form_table">  
