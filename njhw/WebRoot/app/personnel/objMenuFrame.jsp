...
<div class="index_bgs">
	<div class="bgsgl_border_left">
	  	<div class="bgsgl_border_right">菜单管理</div>
	</div>
	<div class="bgsgl_conter">
		...
		<div region="center" title="资源列表" style="background:#fafafa;float: right;width: 80%;height: 400px;">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgList" id="ifrmObjList" src="${ctx}/app/per/objMenuList.act?nodeId=30&resType=M" style="width:100%;height:520px;padding:0px;"></iframe>
		</div>
		<div class="clear"></div>
	</div>
</div>
