...
<div class="index_bgs">
	<div class="bgsgl_border_left">
	  	<div class="bgsgl_border_right">入驻单位</div>
	</div>
	<div class="bgsgl_conter">
		<div region="west" split="true" title="组织机构" style="width:20%;background:#fafafa;padding:0px;overflow:hidden;float: left;height:560px">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgTree" id="ifrmObjTree" src="${ctx}/app/per/orgTree.act"
		border="0" marginheight="0" marginwidth="0" frameborder="0" 
		style="width:100%;height:100%;padding:0px;"></iframe>		
		</div>
		<div region="center" title="列表" style="background:#fafafa;float: right;width: 80%;height: 100%">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgList" id="ifrmObjList" src="${ctx}/app/per/orgList.act?orgId=2" style="width:100%;height:560px;padding:0px;"></iframe>
		</div>
		<div class="clear"></div>
	</div>
</div>
