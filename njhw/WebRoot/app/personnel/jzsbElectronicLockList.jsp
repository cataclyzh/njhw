...
<div id="list"></div>
<form id="queryForm" action="jzsbElectronicLockList.act" method="post"  autocomplete="off" style="height: 520px;">
	<s:hidden name="PId"/>
...
<script type="text/javascript">
	...
	function addRecord(){
		...
		if("14" != nodeId && "13" != nodeId && "15" != nodeId && "1" != nodeId){
			//var url = "${ctx}/app/per/jzsbLockInput.act?nodeId="+nodeId;
	...
	function updateRecord(id,setId){
		...
		openEasyWin("winId","设备更新",url,"600","255",true);
	}
	function delRecord(){
