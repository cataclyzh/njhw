...
<body>
	...
	<div class="bgsgl_border_left">
	  	<div class="bgsgl_border_right">单位管理员设定</div>
	</div>
	<div class="bgsgl_conter" style="height:496px;padding-bottom: 10px;">
	<div class="bgsgl_clear"></div>
	<div split="true" title="单位管理员设定" style="width:25%;background:#fafafa;padding:0px;FLOAT:LEFT;height:100%;">
	<c:if test="${loginId ne '1'}">
		<iframe scrolling="auto" frameborder="0" name="ifrmOrgTree" id="ifrmObjTree" src="${ctx}/app/per/orgTreeUserCheckin.act"
	...
	<div style="width:75%;background:#fafafa;padding:0px;overflow:hidden;FLOAT:LEFT;height:102%;" id = "ifrmObj2">
		<iframe frameborder="0" name="ifrmOrgList" id="ifrmObjList" src="${ctx}/app/personnel/orguser/orgIndex.act?orgId=1" style="width:100%;height:100%;padding:0px;"></iframe>
	</div>
	</div>
	</div>
	</div>
