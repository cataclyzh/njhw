...
<div class="index_bgs">
	<div class="bgsgl_border_left">
	  	<div class="bgsgl_border_right">建筑设备维护</div>
	</div>
	<div class="bgsgl_conter">
		<div region="west" split="true" title="资源树" style="width:20%;background:#fafafa;padding:0px;overflow:hidden;float: left;height:520px">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgTree" id="ifrmObjTree" src="${ctx}/app/per/objTree.act?resType=${resType}"
			border="0" marginheight="0" marginwidth="0" frameborder="0" 
			style="width:100%;height:100%;padding:0px;"></iframe>
		</div>
		<div region="center" title="资源列表" style="background:#fafafa;float: right;width: 80%;height: 100%">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgList" id="ifrmObjList" src="${ctx}/app/per/objList.act?nodeId=6&resType=D" style="width:100%;height:520px;padding:0px;"></iframe>
		</div>
		<div class="clear"></div>
	</div>
</div>
