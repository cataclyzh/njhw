...
<body style="background: #FFF;" class="easyui-layout" id="bo">
...
<table border="0" width="100%" class="form_table inpu_trst" style="margin-top:20px;">
 <tr>
	...
	<td><input type="text" name="keyword" id="keyword" maxlength="20" value="" /></td>   
	<td></td>
 </tr>
 <tr>
	<td></td>
	<td class="form_label"><font style="color:red"></font>备注：</td>
	<td><input type="text" name="title" id="title" maxlength="20" value="" /></td>   
