...
<div class="index_bgs">
	<div class="bgsgl_border_left">
	  	<div class="bgsgl_border_right">设备维护</div>
	</div>
	<div class="bgsgl_conter">
		<div region="west" split="true" title="资源树" style="width:20%;background:#fafafa;padding:0px;overflow:hidden;float: left;height:625px">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgTree" id="ifrmObjTree" src="${ctx}/app/per/jzsbTree.act?resType=${resType}"
		...
		<div region="center" title="资源列表" style="background:#fafafa;float: right;width: 79%;height: 100%">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgList" id="ifrmObjList" src="${ctx}/app/per/jzsbDoorControllerList.act?nodeId=12" style="width:100%;height:628px;padding:0px;"></iframe>
		</div>
		<div class="clear"></div>
	</div>
</div>
