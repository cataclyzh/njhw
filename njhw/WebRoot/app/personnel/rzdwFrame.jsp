...
<div class="index_bgs">
	...
	<div class="bgsgl_conter">
		...
		<div region="center" title="列表" style="background:#fafafa;float: right;width: 100%;height: 100%">
			<iframe scrolling="auto" frameborder="0" name="ifrmOrgList" id="ifrmObjList" src="${ctx}/app/per/rzdwList.act?orgId=2" style="width:100%;height:628px;padding:0px;"></iframe>
		</div>
		<div class="clear"></div>
	</div>
</div>
