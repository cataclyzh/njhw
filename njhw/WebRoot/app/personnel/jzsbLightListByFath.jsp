...
<script type="text/javascript">
	...
	function openInputPage(){
		var url = "${ctx}/app/per/jzjgLightInput.act";
...
<body style="background:#fff;">
   	<div class="bgsgl_right_list_border">
	  	<div class="bgsgl_right_list_left">房间照明</div>
	</div>
<div id="list"></div>
	<form id="queryForm" action="jzsbLightListFath.act" method="post"  autocomplete="off" style="height: 520px;">
	<s:hidden name="PId"/>
...
<script type="text/javascript">
	...
	function addRecord(){
		...
		if("14" != nodeId && "13" != nodeId && "15" != nodeId && "1" != nodeId){
			var url = "${ctx}/app/per/jzjgLightInput.act?nodeId="+nodeId;
			//showShelter('800','600',url);
			//showShelter("550","200",url);
			openEasyWin("winId","设备添加",url,"600","225",true);
		}else{
			var url = "${ctx}/app/per/jzjgLightInput.act?nodeId="+nodeId;
			//showShelter("550","200",url);
	...
	function updateRecord(id){
		var url = "${ctx}/app/per/queryInfoLightInput.act?nodeId="+id +"&pId="+$("#nodeId").val();
		openEasyWin("winId","设备更新",url,"600","225",true);
