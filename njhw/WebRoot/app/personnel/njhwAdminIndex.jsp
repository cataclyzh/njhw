...
<script type="text/javascript">
	...
	$(document).ready(function(){
		//默认第一个左边显示入驻单位信息
		var url = "${ctx}/app/room/init1.act";
	...
	function initNavi(i){
		...
		var url = "";
		if (i == 1) {
			url = "${ctx}/app/per/rzdwFrame.act";
		} else if (i == 2) {
			url = "${ctx}/app/room/init1.act";
		} else if (i == 3) {
...
<body>
	<div class="main_index">
		...
		<div style="width:232px;height:720px;background:#fff;padding:0px;overflow:auto;float:LEFT;">
			<a id="navi1" class="navi_button_a1" href="javascript:void(0);" onclick="javascript:initNavi(1)"></a>
			<a id="navi2" class="navi_button_a2" href="javascript:void(0);" onclick="javascript:initNavi(2)"></a>
			<a id="navi3" class="navi_button_a3" href="javascript:void(0);" onclick="javascript:initNavi(3)"></a>
			<a id="navi4" class="navi_button_a4" href="javascript:void(0);" onclick="javascript:initNavi(4)"></a>
			<a id="navi5" class="navi_button_a5" href="javascript:void(0);" onclick="javascript:initNavi(5)"></a>
			<a id="navi6" class="navi_button_a6" href="javascript:void(0);" onclick="javascript:initNavi(6)"></a>
		...
		<div class="index_bgs" style="width:82%;float:LEFT;height:100%;">
			<iframe frameborder="0" name="njhwAdmin" id="njhwAdmin" src="${ctx}/common/include/body.jsp" style="width:100%;height:100%;padding:0px;"></iframe>
		</div>
		</div>
