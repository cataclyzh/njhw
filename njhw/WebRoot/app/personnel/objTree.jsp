...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/app/per/objTreeDataDev.act?resType=${resType}&type=open");
	tree.loadXML("${ctx}/app/per/objTreeDataDev.act?resType=${resType}&type=init&id=<c:out value='${_orgid}'/>");//
