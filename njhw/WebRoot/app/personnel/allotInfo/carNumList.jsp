 	...
 	<h:panel id="query_panel" width="100%" title="查询条件">
      <table align="center"  id="hide_table" border="0" width="100%" class="form_table">
        <tr>
          ...
          <td width="30%">
          	<input id="carPortsNum" name="carPortsNum" value="${carPortsNum}" type="text" maxlength="5" onkeyup="value=value.replace(/[^\d]/g,'');"/>
          	<%-- 
          	${carPortsNum}
          	--%>
          </td>
        ...
        <tr>
          <td colspan="4" class="form_bottom">
            <s:textfield name="page.pageSize" id="pageSize" theme="simple" cssStyle="width:20px" onblur="return checkPageSize();" onkeyup="value=value.replace(/[^\d]/g,'');" />条/页&nbsp;&nbsp;
          	<a href="javascript:void(0);" class="easyui-linkbutton" id="searchbutton" iconCls="icon-save" onclick="saveSubmit();">保存</a>
          	<a href="javascript:void(0);" class="easyui-linkbutton" id="resetbutton" iconCls="icon-reload" onclick="resetCheckboxForm('#saveForm');">重置</a>
          </td>
        </tr>
      </table>      
   </h:panel>
