...
- Author: zh
- Date: 2013-4-7
- Description: IP电话号码分配机构列表
--%>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>IP电话号码分配机构列表</title>
...
<body style="height:100%;width:100%;" class="easyui-layout">
		...
		<form id="queryForm"  method="post"  autocomplete="off">
			...
			<d:table name="page.result" id="row" uid="row" export="false" class="table"	requestURI="list.act?exFile=1">	
			    ...
			    <d:col class="display_centeralign"  media="html" title="分配">	
					<a href="javascript:void(0);" onclick="allotIPPhoneNum('${row.orgId}')">[分配]</a>&nbsp;	
				</d:col>
			</d:table>
			</h:page>
		</form>
	</div>
	<div id="allotCar" region="center" title="部门IP电话号码分配" style="padding:0px;background:#fafafa;overflow:hidden;">
		<div id="center" title="部门IP电话号码分配" style="width:100%;height:100%;padding:0px;background:#fafafa;overflow:hidden;">
	...
	<script type="text/javascript">
	    function allotIPPhoneNum(orgId){
	    	var url = "${ctx}/app/allotIPNum/list.act?orgId="+orgId;
