...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/app/per/orgOtherUserCheckinData.act?type=open");
	tree.loadXML("${ctx}/app/per/orgOtherUserCheckinData.act?type=init&id=<c:out value='${_orgid}'/>");//
	...
	function reload(){
		...
		if (selectedNode==""){
			 location.reload();
			 parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinOther.act";
		}else{
			//parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinOther.act";
			parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinOther.act?selectedNode=" + selectedNode;
		}
	}
   ...
   var isDra = true;
	...
	function myDragHandler(idFrom,idTo){
	    if(isDra)
	    {
			...
			parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinOther.act?selectedNode=" + idFrom;
						...
						$.ajax({
						   ...
						   success: function(msg){
							   ...
							   if(msg.message=="0"){
							   		...
							   		parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckinOther.act?selectedNode=" + selectedNodeOld;						
