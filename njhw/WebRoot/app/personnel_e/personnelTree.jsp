...
//	tree.enableContextMenu(menu);
	...
	tree.setXMLAutoLoading("${ctx}/app/per/orgTreeUserCheckinData.act?type=open&telType=0");
	tree.loadXML("${ctx}/app/per/orgTreeUserCheckinData.act?type=init&id=<c:out value='${_orgid}'/>&telType=0");//
	...
	function addUser(){
	    ...
	    selectedNode = selectedNode.substring(0,selectedNode.indexOf("-o"));
		var url = "${ctx}/app/e4personnel/registerPage.act?ispopup=n&orgId=" + selectedNode;
		parent.frames.ifrmOrgList.location.href = url;
	...
	function reload(){
		...
		if (selectedNode==""){
			 location.reload();
			 parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckin.act";
		}else{
			//parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckin.act";
			parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckin.act?selectedNode=" + selectedNode;
		}
	}
   ...
   var isDra = true;
	...
	function myDragHandler(idFrom,idTo){
	    if(isDra)
	    {
			...
			parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckin.act?selectedNode=" + idFrom;
						...
						$.ajax({
						   ...
						   success: function(msg){
							   ...
							   if(msg.message=="0"){
							   		...
							   		parent.frames.ifrmObjTree.location.href = "${ctx}/app/per/orgTreeUserCheckin.act?selectedNode=" + selectedNodeOld;						
   ...
   function search2(){
    ...
    function findPlace(id){
    	...
    	$("#searchUserOrOrg").hide();
  	   $("#divTree").show();
        var url = "${ctx}/app/per/inputRegister.act?ispopup=n&orgId="+orgId+"&userId="+id;
