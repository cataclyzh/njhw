...
/* 					$("#allocatedTel").text($("#allocatedTelHidden").val());
			...
			*/
			function distribute(telID,telType){
				...
				//showShelter('600','400',url);
				windowDialog("<span style='color:#808080;font-family:\"微软雅黑\";font-size:14px;font-weight:bold;'>网络传真新增</span>",url,100,'750','320'); 
			}
				    ...
				    <table align="center"  id="hide_table" border="0" width="100%" class="form_table">
						<tbody>
							<tr style="height: 30px">
								...
								<td style="width:15%">
									<select id="disStatus" name="disStatus" style="width: 200px; height: 26px">
...
<%-- 							<td style="width: 5%;text-align:right;">
								...
								<td style="width:15%">
							 	...
							 	<td style="width: 5%;text-align:right;">
									<div class="table_btn1" style="margin-top: -6px;" onClick="javascript:btnSearchTelAndNum();">查询</div>
								</td>
							</tr>
