...
<head>
	...
	<script src="${ctx}/app/integrateservice/js/indexE.js" type="text/javascript"></script>
	...
	<style type="text/css">
		...
		.other_weather{
			...
			font-weight:bold;
			font-family: Arial,Helvetica,sans-serif;
			border-bottom: 1px solid #7F90B3;
			padding: 5px 0;
		}
		...
		.weather_txt1, .weather_txt2, .weather_txt3{
			font-size: 13px;
			color: #808080;
			font-family: Arial,Helvetica,sans-serif;
			float:left;
		...
		.weather_img1, .weather_img2, .weather_img3{
			float: left;
		}
	</style>
...
<div>
	<div class="mina1_left">
		<div class="main_left_main1">
			...
			<div style="border:1px solid #7F90B3;padding:0 10px;height:634px">
		        ...
		        <div class="other_weather">未来三天天气</div>
		        
		        <div class="weather1">
		        	<div class="week1"></div>
		        	<div class="clear"></div>
		        	<div>
		        		<img class="weather_img1"></img><div class="temperature1"></div>
		        		<div class=weather_txt1>
		        			<span class="weather_txt1_top"></span><br/>
		        			<span class="weather_txt1_down"></span>
		        		</div>
		        	</div>
		        </div>
		        <div class="weather2">
		        	...
		        	<div class="clear"></div>
		        	<div>
		        		<img class="weather_img2"></img><div class="temperature2"></div>
		        		<div class=weather_txt2>
		        			<span class="weather_txt2_top"></span><br/>
		        			<span class="weather_txt2_down"></span>
		        		</div>
		        	</div>
		        </div>
		        <div class="weather3">
		        	...
		        	<div class="clear"></div>
		        	<div>
		        		<img class="weather_img3"></img><div class="temperature3"></div>
		        		<div class=weather_txt3>
		        			<span class="weather_txt3_top"></span><br/>
		        			<span class="weather_txt3_down"></span>
		        		</div>
		        	</div>
		        </div>
			</div>
		</div>
		<div style="clean:both;height:1px"></div>
	...
	<div class="mina_center">
		...
		<div class="main_left_main1" style="overflow: hidden;">
			...
			<div class="main_conter" style="height:196px;">
				<div class="main_main1" style="margin:10px 0">
					<ul>
			...
			<a style="cursor: pointer;" href="${ctx}/app/integrateservice/weekMenusQuery.act">
				<img class="st_img1" style="margin: 13px 0 0 0" src="images/t_4.jpg" width="72" height="17" border="0" />
			</a>
			<div class="clear"></div>
		</div>
	</div>
	...
	<div class="wuye_main">
		...
		<div class="main_conter" style="height:389px;">
			<div class="mina2_left" style="height:300px">
