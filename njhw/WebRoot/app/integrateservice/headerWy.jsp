...
<div class="main_header1">
	...
	<input type="hidden" id="urlButton" value="${empty param.gotoParentPath ? 0 : param.gotoParentPath}" />
  	<div class="header_right" style="width:395px;" id="headWidth">
   		<div style="width: 108px;float: left;"><a id="prveId" style="visibility:hidden;cursor:pointer;color:#9eadcc;background-image: url('<%=path%>/app/integrateservice/images/index_tip.jpg');text-decoration: none;" onclick="gotoUrl()">返回物业首页</a></div>
		...
		<a id="gljId" style="margin:5px 0px 0 0;background-image:none;float:right;display:none;cursor:pointer;color:#FEC600;font-weight: bold;">管理局功能入口</a>
