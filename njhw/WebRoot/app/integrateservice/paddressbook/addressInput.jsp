...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(document).ready(function() {
			//添加传真号码
			//alert($.trim(getQueryString("fax_no")));
			if(getQueryString("titleNum")=="add"&&$.trim(getQueryString("fax_no"))!="")
...
<div class="energy_fkdj_botton_ls">
						...
						<a style="cursor: pointer;" class="fkdj_botton_right" onclick="reloadGroup()">关闭</a>
</div>
		</form>
	</div>
	</body>
...
function reloadGroup(){
	if(parent.parent.document.getElementById("iframeReLoad") != null){
 	...
 	parent.closeIframe1('newTreeAddressListClose');
}
</script>