...
<div class="user_mes" id="user_mes">
	...
	<div class="us_bg2" id="us_bg2" title="个人信息"
		onmouseover="change_col(1,0,'-50px','us_bg2')"
		onmouseout="change_col(1,1,'-50px','us_bg2')" onclick="openPwdDiv()"></div>
	<div class="set" id="set">
		<a title="个人信息" id="UserInfo" onclick="openPwdDiv()"
			onmouseover="change_col(1,0,'-50px','us_bg2')"
			onmouseout="change_col(1,1,'-50px','us_bg2')" hidefocus>个人信息</a>
	</div>
	
	<div style="display: none;" class="us_bg4" id="us_bg4" onclick="javascript:playWin('open');" title="任务" onmouseover="change_col(3,0,'-150px','us_bg4')" onmouseout="change_col(3,1,'-150px','us_bg4')" onclick="open_top(3)"></div>
	<div style="display: none;" class="talk" id="talk" onclick="javascript:playWin('open');"><a title="任务" id="Discuss"  onclick="javascript:playWin('open');" onmouseover="change_col(3,0,'-150px','us_bg4')" onmouseout="change_col(3,1,'-150px','us_bg4')" hidefocus>任务</a></div>
	<div style="display: none;" id="msg_task_size" onclick="javascript:playWin('open');"  class="header_message" ><span>0</span></div>
