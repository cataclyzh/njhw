...
<head>
  ...
  <body>
    <form  id="inputForm" action="sendMessage.act"  method="post"  autocomplete="off" >
	<table align="center" border="0" width="100%" class="form_table">
      <tr>
	        <td class="form_label"><font style="color:red">*</font>手机号：</td>
	        
	        <td>
	         <s:textfield name="phoneNumber" theme="simple" size="18" maxlength="20"/>
	        </td> 
        </tr>
        
        <tr>
        <td class="form_label"><font style="color:red">*</font>发送内容：</td>
	        
	        <td>
	         <s:textfield name="sendContent" theme="simple" size="18" maxlength="20"/>
	        </td> 
        </tr>
