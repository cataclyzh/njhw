...
<head>
  ...
  <body>
    <form  id="inputForm" action="controlDoor.act"  method="post"  autocomplete="off" >
	<table align="center" border="0" width="100%" class="form_table">
      <tr>
	        <td class="form_label"><font style="color:red">*</font>房间号：</td>
	        
	        <td>
	         <s:textfield name="myHome" theme="simple" size="18" maxlength="20"/>
	        </td> 
        </tr>
