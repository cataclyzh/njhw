				    ...
				    <script type="text/html" id="commute_detail_template">
        				<div id='commute_info'>
          					...
          					<div class="commute-detail-content">
            					<!--上午考勤-->
            					{{#commute_morning_0}}
              						<span><a href="#{{user_id}}" class="user-apply-commute fc-event-morning-{{commute_morning_date}}" rel="{{commute_morning_date}}" id="apply_morning">上午刷卡异常说明</a></span>
            					{{/commute_morning_0}}
            					...
            					<!--下午考勤-->
            					{{#commute_afternoon_0}}
              						<span><a href="#{{user_id}}" class="user-apply-commute fc-event-afternoon-{{commute_afternoon_date}}" rel="{{commute_afternoon_date}}" id="apply_afternoon">下午刷卡异常说明</a></span>
            					{{/commute_afternoon_0}}
