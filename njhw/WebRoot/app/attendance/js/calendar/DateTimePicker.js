...
;(function ( $, window, document, undefined ) {
		...
		DateTimePicker.prototype = {
			...
			_addEventHandlersForInput: function()
			{
			    ...
			    //$("[data-field='date'], [data-field='time'], [data-field='datetime']").off("focus", dtPickerObj._inputFieldFocus);
				$("[data-field='date'], [data-field='time'], [data-field='datetime']").unbind("focus", dtPickerObj._inputFieldFocus);
				$("[data-field='date'], [data-field='time'], [data-field='datetime']").bind("focus", {"obj": dtPickerObj}, dtPickerObj._inputFieldFocus);
			...
			_parseTime: function(sTime)
			{
				...
				if(sTime != "" &&  sTime != undefined && sTime != null)
				{
					if(dtPickerObj._compare(dtPickerObj.dataObject.sTimeFormat, dtPickerObj.dataObject.sArrInputTimeFormats[0]))  //  "hh:mm AA"
					{
						...
						iHour = parseInt(sArrTimeComp[0], 10);
						iMinutes = parseInt(sArrTimeComp[1], 10);
