...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
                  var allDivs =$('#wizard_content').children('div'); //$("div", obj);                
                  $('.wizard_mbx').children('ul').addClass("anchor");
                  allDivs.addClass("content");
                  // Create Elements
                  loader = $('<div></div>').addClass("loader");
                  elmActionBar = $('<div></div>').addClass("actionBar");
                  elmStepContainer = $('<div></div>').addClass("stepContainer");
                  btFirst = $('<a>'+options.labelFirst+'</a>').attr("href","#").addClass("buttonFirst");
                  ...
                  elmActionBar.append(btFirst).append(btNext).append(btPrevious); 
                ...
                function prepareSteps(){
                  if(!options.enableAllSteps){
                    ...
                    $("span", steps).removeClass("selected").removeClass("done").addClass("disabled");
                ...
                function LoadContent(stepIdx){
                	...
                	if (stepIdx < curStepIdx) {
                        $(curStep, obj).addClass("disabled");
                        $("span", curStep).addClass("disabled");
                	}
                ...
                function SetupStep(curStep,selStep){
                   ...
                   $("span", selStep).removeClass("disabled");
