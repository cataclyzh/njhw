...
public class PageTag1 extends TagSupport {
	...
	private String callback = "jumpPage";
	...
	private String getPanelEnd() {
		...
		buf.append("<tr width=\"100%\" bgcolor=\"#E0E3EA\">");
		...
		if(buttons!=null){
			...
			while (st.hasMoreTokens()) { 
				...
				if("add".equals(token)){
					buf.append("<a href=\"javascript:void(0);\" id=\"addSource\" class=\"easyui-linkbutton\"  onclick=\"javascript:addRecord();\">新增</a>&nbsp;");
				}else if("del".equals(token)){
					buf.append("<a href=\"javascript:void(0);\" id=\"delSource\" class=\"easyui-linkbutton\" onclick=\"javascript:delRecord();\">删除</a>&nbsp;");
				...
				}else if("marge".equals(token)){
					buf.append("<a href=\"#\" id='Merger' style='display:none;' class=\"easyui-linkbutton\" onclick=\"javascript:marge();\">合并</a>&nbsp;");
				}
...
//			buf.append("共"+page.getTotalCount()+"条记录,第"+page.getPageNo()+"页, 共"+pageCount+"页  ");
			...
			if (pageNo == 1) {
				...
				buf.append("<a class=\"page_a\" id=\"firstPageTag\" href=\"javascript:void(0);\" onclick=\""+callback+"(")
				  .append((1))
				  .append(")\">&lt;&lt;</a>\r\n");
				
				buf.append("<a class=\"page_a\" href=\"javascript:void(0);\" onclick=\""+callback+"(")
				  .append((pageNo - 1))
				  .append(")\">&lt;</a>\r\n");
			...
			if(pageNo > 4){
				...
				buf.append("<a class=\"page_a\" href=\"javascript:void(0);\" onclick=\""+callback+"(1)\">1</a>\r\n");
				buf.append("<a class=\"page_a\" href=\"javascript:void(0);\" onclick=\""+callback+"(2)\">2</a>\r\n");
				buf.append("<a class=\"page_a\" href=\"javascript:void(0);\"\">");
				buf.append("&hellip;");
				buf.append("</a>\r\n");
			}
