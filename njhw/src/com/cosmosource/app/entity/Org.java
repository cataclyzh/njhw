...
public class Org implements java.io.Serializable {
	...
	public static final Long ORG_PID_2 = 2L;  //  新城二期
	private Long orgId;
	private String name;
	...
	/** full constructor */
	public Org(Long orgId, String name, String shortName,
			String levelNum, Long PId, Long orderNum, String memo,
			String type, String orgCode, String ext1, String ext2,String telId,String telFaxid) {
		this.orgId = orgId;
		this.name = name;
	 ...
	 * @since   CodingExample Ver(编码范例查看) 1.0 
	 */
	@Column(name = "TEL_FAXID", length = 12)
	public String getTelFaxid()
	{
		return telFaxid;
	}

	/** 
	 * @param telFaxid the telFaxid to set 
	 */
	
	public void setTelFaxid(String telFaxid)
	{
		this.telFaxid = telFaxid;
	}
