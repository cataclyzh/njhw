...
//		String original_data = request.getParameter("original_data");
//		String original_jsp = request.getParameter("original_jsp");
//		String signed_data = request.getParameter("signed_data");
//		System.out.println(appId +"--------"+authURL+"-----"+original_data+"---------"+original_jsp+"--------"+signed_data);
//
...
//					+ authURL + "\n");
//			 
//					if (isNotNull(original_data)
//							&& isNotNull(signed_data)&&isNotNull(original_jsp)) {
//						// 获取session中的认证原文
