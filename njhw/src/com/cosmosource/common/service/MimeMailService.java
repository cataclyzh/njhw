...
public class MimeMailService {
	...
	public void sendNotificationMail(String userName) {
		...
		try {
			...
			helper.setTo("WXJ@Cosmosource.com");
			helper.setFrom("service@Cosmosource.com");
			helper.setSubject("用户找回密码通知");
			...
			mailSender.send(msg);
			logger.info("HTML版邮件已发送至WXJ@Cosmosource.com");
	...
	private File generateAttachment() throws MessagingException {
		try {
			Resource resource = new ClassPathResource("/com/cosmosource/common/properties/mailAttachment.txt");
