...
public class RmbCapitalFormatter { 
	...
	public static void main(String[] args) {
		RmbCapitalFormatter aa = new RmbCapitalFormatter();
		aa.setPrefix("人民币");
		System.out.println(aa.format(new Double(00)));
	}
     ...
     public  String format(Double data) { 
         ...
         //小数部分，只有前两位小数有意义 
         int fractionPart = (int) Math.round((data - intPart) * 100); 
